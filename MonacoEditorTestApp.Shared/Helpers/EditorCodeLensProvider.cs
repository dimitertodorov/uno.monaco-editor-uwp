...
namespace MonacoEditorTestApp.Helpers
{
    public class EditorCodeLensProvider : CodeLensProvider
    {
                    ...
                    Lenses = new CodeLens[]
                    {
                        new CodeLens()
                        {
                            ...
                            Command = new Command()
                            {
                                ...
                                {
                                    "Arg 1", 5, new float[] { 4.5f, 0.3f }
                                }, // Note: This 3rd element array will come back as a JArray TODO?
        ...
        {
            return AsyncInfo.Run(delegate(CancellationToken cancelationToken) { return Task.FromResult(codeLens); });
        }
    }
}